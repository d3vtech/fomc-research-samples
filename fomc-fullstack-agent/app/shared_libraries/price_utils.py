...
def compute_probabilities(meeting_date_str: str) -> dict:
    ...
    output = {
        "Odds of a rate move within the next year (computed before Fed meeting)": probs_pre,
        "Odds of a rate move within the next year (computed after Fed meeting)": probs_post,
    }
